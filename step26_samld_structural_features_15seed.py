...
SEEDS = (42, 1, 7, 123, 2024, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12)  # نسخه‌ی ۱۵-seed، بازبینی سوال معناداری
...
if __name__ == "__main__":
    ...
    if p_val < 0.05:
        ...
        print(f"-> NOT statistically significant with {len(SEEDS)} seeds -- treat the improvement "
